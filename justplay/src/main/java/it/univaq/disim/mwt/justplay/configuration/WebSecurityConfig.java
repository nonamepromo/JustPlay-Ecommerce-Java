...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.headers().disable().csrf().disable()
				...
				.failureUrl("/common/login?error=invalidlogin").defaultSuccessUrl("/videogiochi/list?platform=all&index=1", false)
				.and().logout().logoutSuccessUrl("/videogiochi/list?platform=all&index=1")
				...
				.antMatchers("/videogiochi/addGameToSellinglistProva").authenticated();
