...
public class JDBCUtenteServiceImpl implements UtenteService {
	...
	private static final String UPDATE_PROFILE = "UPDATE utenti SET email=? WHERE id_utente=?";
	...
	public void updateProfilo(Utente nuovoProfilo) throws BusinessException {
		...
		try (Connection con = dataSource.getConnection();
			...
			st.setDate(2, Date.valueOf(nuovoProfilo.getDataNascita()));
			st.setLong(3, nuovoProfilo.getId());
			st.executeUpdate();
